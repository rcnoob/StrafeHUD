...
{
    public MemoryFunctionVoid<IntPtr, IntPtr, IntPtr, CCSPlayer_MovementServices> _RunCommand = new(GameData.GetSignature("RunCommand"));
...
{
    public MemoryFunctionVoid<CCSPlayer_MovementServices, IntPtr> _RunCommand = new(GameData.GetSignature("RunCommand"));
